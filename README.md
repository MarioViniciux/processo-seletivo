...
Conectar interface ao backend.

Campo `owner` deve ser **combobox autocomplete**.

---

### Nível 3 — Listagens

Listar ativos mostrando:
...
Na página de detalhes, exibir também os dados do responsável.
